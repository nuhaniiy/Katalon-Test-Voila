...
WebUI.takeScreenshot()
WebUI.scrollToElement(findTestObject('Object Repository/Filtering/text available voucher'), 0)
WebUI.verifyElementPresent(findTestObject('Object Repository/Filtering/text jakarta moi 2'), 0, FailureHandling.STOP_ON_FAILURE)
WebUI.takeScreenshot()
...
WebUI.click(findTestObject('Object Repository/Filtering/text bags 1'))
WebUI.takeScreenshot()
WebUI.scrollToElement(findTestObject('Object Repository/Filtering/text available voucher'), 0)
WebUI.verifyElementPresent(findTestObject('Object Repository/Filtering/text bags 2'), 0, FailureHandling.STOP_ON_FAILURE)
WebUI.takeScreenshot()
