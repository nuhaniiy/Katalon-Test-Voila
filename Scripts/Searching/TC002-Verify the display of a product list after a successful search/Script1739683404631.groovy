...
WebUI.delay(5)
WebUI.takeScreenshot()
WebUI.verifyElementPresent(findTestObject('Object Repository/Searching/img_Rp2.750.000__1nvnchg9'), 0, FailureHandling.STOP_ON_FAILURE)
WebUI.takeScreenshot()
WebUI.click(findTestObject('Object Repository/Searching/img_Rp2.750.000__1nvnchg9'))
WebUI.verifyElementPresent(findTestObject('Object Repository/Searching/text options available'), 0, FailureHandling.STOP_ON_FAILURE)
WebUI.takeScreenshot()
