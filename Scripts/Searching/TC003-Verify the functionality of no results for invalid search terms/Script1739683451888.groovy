...
WebUI.takeScreenshot()
WebUI.setText(findTestObject('Object Repository/Searching/input search'), 'samsung')
WebUI.takeScreenshot()
WebUI.sendKeys(findTestObject('Object Repository/Searching/input search'), Keys.chord(Keys.ENTER))
WebUI.verifyElementPresent(findTestObject('Object Repository/Searching/text product not found'), 0, FailureHandling.STOP_ON_FAILURE)
WebUI.takeScreenshot()
WebUI.closeBrowser()
