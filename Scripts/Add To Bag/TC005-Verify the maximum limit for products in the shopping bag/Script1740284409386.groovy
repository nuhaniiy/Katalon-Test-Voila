...
WebUI.delay(2)
WebUI.click(findTestObject('Object Repository/Add to Bag/Add to Bag'), FailureHandling.STOP_ON_FAILURE)
WebUI.verifyElementPresent(findTestObject('Object Repository/Add to Bag/Max Product'), 0, FailureHandling.STOP_ON_FAILURE)
WebUI.takeScreenshot()


WebUI.click(findTestObject('Object Repository/Add to Bag/Bag Menu'), FailureHandling.STOP_ON_FAILURE)
WebUI.verifyElementPresent(findTestObject('Object Repository/Add to Bag/adidas samba - clay - bag'), 0, FailureHandling.STOP_ON_FAILURE)


//WebUI.click(findTestObject('Object Repository/Add to Bag/Remove Product'))
